...
public class JPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private boolean mEventType = true;
...
//        tab.setFocusable(true);
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            System.out.println(position + "----" + ((RadioButton) tabsContainer.getChildAt(position)).isChecked());
            if (delegatePageListener != null) {
    ...
    public void setTextColorStateResource(int resId) {
        mTabTextColorStateList = getResources().getColorStateList(resId);
        updateTabStyles();
    }
