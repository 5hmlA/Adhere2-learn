...
import com.jonas.yun_library.widget.VerticalImageSpan;
...
public class SpanUtills {
     ...
     * @return
     */
    public static SpannableString getSynchysis(View view, String orignmsg, String from, int toRes) {
        SpannableString spannableString = new SpannableString(orignmsg);
        Pattern pattern = Pattern.compile(from);
        Matcher matcher = pattern.matcher(orignmsg);
        while (matcher.find()) {
            spannableString.setSpan(
                    new VerticalImageSpan(view.getContext().getApplicationContext(), toRes),
     ...
     * @return
     */
    public static SpannableString getSynchysis(View view, SpannableString orignmsg, String from, int toRes) {
        Pattern pattern = Pattern.compile(from);
        Matcher matcher = pattern.matcher(orignmsg);
        while (matcher.find()) {
            orignmsg.setSpan(
